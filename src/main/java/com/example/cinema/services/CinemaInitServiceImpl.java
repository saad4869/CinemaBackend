...
public class CinemaInitServiceImpl implements ICinemaInitService {
    ...
    public void initCinemas() {
        ...
        {
            Stream.of("Megarama","IMAX","RIALTO","LYNX","DAOULIZ")
                    .forEach(nameCinema->
                    {
    ...
    public void initFilms() {
        ...
        Stream.of("Avengers","SpiderMan","The Old Guard","DUNKIRK","I AM LEGEND")
                .forEach(titreFilm->
                {
                    Film film = new Film();
    ...
    public void initProjections() {
        double[] prices = new double[] {30,50,60,70,90,150};
    ...
    public void initTickets() {
        projectionRepository.findAll().forEach(p->
        {
            p.getSalle().getPlaces().forEach(place->
            {
                ...
                ticket.setReservationState(false);
